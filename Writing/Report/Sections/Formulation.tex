Consider a worker $i$ and an opportunity at a firm $j$. Suppose there are $n$ firms, but worker $i$ did not express complete preferences, $n_i < n$. Suppose there are $m$ workers in the compulsory market.
